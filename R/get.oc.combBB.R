...
#'
#' Obtain the operating characteristics of the BOIN-CX design for drug combination
#'  trials. The BOIN-CX design is to find a MTD within specified drug combinations in the dose matrix.
#'
...
#'
#' @details The operating characteristics of the BOIN-CX design are generated by
...
#'
#'
#' The BOIN-CX design has two built-in stopping rules:
